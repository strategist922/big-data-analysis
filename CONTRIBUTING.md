...
1. Determine which repository the bug/feature should be reported in. The process
   ...
   issue.
2. Search current open GitHub [issues](https://github.com/duttashi/bigdatanalysis/issues)
...
4. If the bug exists in the HEAD of master, and you can't find an open issue,
   then [open a new issue](https://github.com/duttashi/bigdatanalysis/issues).
   Please be sure to:
